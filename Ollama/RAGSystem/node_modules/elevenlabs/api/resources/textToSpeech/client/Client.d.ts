...
export declare class TextToSpeech {
     ...
     *     })
     */
    convertWithTimestamps(voiceId: string, request: ElevenLabs.TextToSpeechWithTimestampsRequest, requestOptions?: TextToSpeech.RequestOptions): Promise<ElevenLabs.AudioWithTimestampsResponseModel>;
    /**
     ...
     */
    streamWithTimestamps(voiceId: string, request: ElevenLabs.StreamTextToSpeechWithTimstampsRequest, requestOptions?: TextToSpeech.RequestOptions): Promise<core.Stream<ElevenLabs.StreamingAudioChunkWithTimestampsResponseModel>>;
}
