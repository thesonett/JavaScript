 ...
 */
export declare enum VLMModelProvider {
    Openai = "openai",
    Anthropic = "anthropic",
    Bedrock = "bedrock",
...
/** @internal */
export declare const VLMModel$inboundSchema: z.ZodType<VLMModelOpen, z.ZodTypeDef, unknown>;
/** @internal */
export declare const VLMModel$outboundSchema: z.ZodType<VLMModelOpen, z.ZodTypeDef, VLMModelOpen>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace VLMModel$ {
    /** @deprecated use `VLMModel$inboundSchema` instead. */
    const inboundSchema: z.ZodType<VLMModelOpen, z.ZodTypeDef, unknown>;
    /** @deprecated use `VLMModel$outboundSchema` instead. */
    const outboundSchema: z.ZodType<VLMModelOpen, z.ZodTypeDef, VLMModelOpen>;
}
/** @internal */
export declare const VLMModelProvider$inboundSchema: z.ZodType<VLMModelProviderOpen, z.ZodTypeDef, unknown>;
/** @internal */
export declare const VLMModelProvider$outboundSchema: z.ZodType<VLMModelProviderOpen, z.ZodTypeDef, VLMModelProviderOpen>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace VLMModelProvider$ {
    /** @deprecated use `VLMModelProvider$inboundSchema` instead. */
    const inboundSchema: z.ZodType<VLMModelProviderOpen, z.ZodTypeDef, unknown>;
    /** @deprecated use `VLMModelProvider$outboundSchema` instead. */
    const outboundSchema: z.ZodType<VLMModelProviderOpen, z.ZodTypeDef, VLMModelProviderOpen>;
}
/** @internal */
